...
/**
 * Teradata-specific SQL script.
 */
class TeradataSqlScript extends ExecutableSqlScript {
    TeradataSqlScript(Configuration configuration, LoadableResource sqlScriptResource, boolean mixed, PlaceholderReplacer placeholderReplacer) {
